const members = {
    ...
    "01532023080":{
        name:"Sony Hasan",
        pre_previous_payable:3666,
        previous_paid       :5700,
        previous_dining_cost:1624,
        payment             :{"02/10/23-Cash":1000,
                             "07/10/23-Cash":3000
                             },
        // running month
        stay_cost       :2500,
    ...
    "01925315230":{
        name:"Masum",
        pre_previous_payable:4810,
        previous_paid       :7000,
        previous_dining_cost:2030,
        payment             :{"12/10/23-Cash":7500},
        // running month
        stay_cost       :4500,
        garage_cost     :50,
    ...
    "01640454889":{
        name:"Imran",
        pre_previous_payable:3870,
        previous_paid       :6000,
        previous_dining_cost:3248,
        payment             :{"28/09/23-Cash":500,
                               "13/10/23-Cash":6000                           
                             },
        // running month
        stay_cost       :2330,
    ...
    "01738393696":{
        name:"Amrul Qais",
        pre_previous_payable:2006,
        previous_paid       :5000,
        previous_dining_cost:2128,
        payment             :{"02/10/23-Cash":5000},
        // running month
        stay_cost       :3000,
        garage_cost     :100,
